...
exports.default = _default;
        var $f89a6a = exports.default || module.exports;
      
      if (typeof $f89a6a === 'function') {
        $f89a6a = $f89a6a.options;
      }
    
        /* template */
        Object.assign($f89a6a, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f89a6a', $f89a6a);
          } else {
            api.reload('$f89a6a', $f89a6a);
          }
        }
